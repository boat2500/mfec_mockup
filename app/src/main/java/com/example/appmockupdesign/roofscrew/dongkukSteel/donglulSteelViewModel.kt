...
class dongSteelViewModel: ViewModel(){
    fun addDong(context: Context, blueData: ArrayList<RoofScrewData>){
        blueData.apply {
    ...
    fun goTodetail(context: Context, dongData: ArrayList<RoofScrewData>){
        val intent = Intent(context, DongkukSteelDetail::class.java)
        intent.putExtra(NotificationCompat.EXTRA_PEOPLE, "1")
